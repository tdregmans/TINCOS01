...
int main(int argc, char **argv) {
  ...
  Node *PR_LED_0 = supervisor->getFromDef("PR_2_LED_0");
  Node *PR_LED_1 = supervisor->getFromDef("PR_2_LED_1");
  Node *PR_LED_2 = supervisor->getFromDef("PR_2_LED_2");
  Node *PR_LED_3 = supervisor->getFromDef("PR_2_LED_3");
  
  DistanceSensor *PR_DS_0 = supervisor->getDistanceSensor("PR_2_DS_0");
  DistanceSensor *PR_DS_1 = supervisor->getDistanceSensor("PR_2_DS_1");
  DistanceSensor *PR_DS_2 = supervisor->getDistanceSensor("PR_2_DS_2");
  DistanceSensor *PR_DS_3 = supervisor->getDistanceSensor("PR_2_DS_3");
